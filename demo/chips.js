angular.module('myModule', ['chips-input'])
    .controller('myCtrl', function ($scope, chipsInput) {
        ...
        chipsInput.init({chips: ["hey", "billy"], chipStyle : {color: '#91d6f0', 'background': '#f4f4f4', 'height': '40px'}, closeBtnStyle : {color : '#888'}, inputStyle : {background : 'inherit'}, autofocus: true, maxlength: 20, chipType : 'rounded'});
